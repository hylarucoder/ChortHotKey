...
ShowMessage("Kommand", "Welcome to Kommand", "k32.png")

if ((%computername% = JENIVICE) OR (%computername% = LOTISY))
     StartViperMode(true)
else
     StartKommandMode(true)


;||=====================================||;
;||     Helper Functions                ||;
;||=====================================||;
StartKommandMode(Silent)
{
     global
     Menu, Tray, Icon, Kommand.ico, 0, 1
     RegWrite, REG_DWORD, HKEY_CURRENT_USER, Software\Microsoft\Windows\CurrentVersion\Policies\System, DisableLockWorkstation, 0
     ViperMode := 0
     if (Silent == false)
          ShowMessage("Kommand", "The default key bindings are enabled.", "k32.png")
}

StartViperMode(Silent)
{
     global
     Menu, Tray, Icon, Viper.ico, 0, 1
     RegWrite, REG_DWORD, HKEY_CURRENT_USER, Software\Microsoft\Windows\CurrentVersion\Policies\System, DisableLockWorkstation, 1
     ViperMode := 1
     if (Silent == false)
          ShowMessage("Viper", "Viper key bindings are enabled.", "v32.png")
}
...
#Capslock::
     if (ViperMode = 0)
          StartViperMode(false)
     else
          StartKommandMode(false)
return
...
#!Space::          RunAndFocus("http://spreadsheets.google.com/ccc?key=t2OJGOtTMCk2aCbNoe6oJnA&hl=en")
...
#3::          RunAndFocus("C:\Downloads")
#+3::          RunAndFocus("C:\Files\Public")
#4::          RunAndFocus("C:\Kylir")
#+4::          RunAndFocus(USERPROFILE)
#5::          RunAndFocus("C:\Vast")
#6::          RunAndFocus("C:\Mindy")
#7::          RunAndFocus("C:\Resources")
#8::          RunAndFocus("C:\Windows")
#9::          RunAndFocus("C:\Program Files (x86)")
#+9::          RunAndFocus("C:\Program Files")
#0::          RunAndFocus("Control")
#+0::          RunAndFocus("C:\Application")
...
#!n::          RunAndFocus("C:\Program Files (x86)\Vim\vim72\gvim.exe")
...
#!s::          Run %USERPROFILE%\AppData\Local\Microsoft\Live Mesh\Bin\Servicing\0.9.4014.4\MoeMonitor.exe,,UseErrorLevel ;TODO - Fix this so it uses RunAndFocus.
...
#v::          RunAndFocus("C:\Program Files (x86)\Microsoft Visual Studio 9.0\Common7\IDE\devenv.exe")
#+v::          RunAndFocus("C:\Program Files (x86)\Eclipse\eclipse.exe")
